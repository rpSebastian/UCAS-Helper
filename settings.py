...
USER_INFO = {
    ...
    'SCKEY': '' # 方糖推送KEY; http://sc.ftqq.com/3.version
}
SOURCE_DIR = '' # 本地课件下载目录
SELECT_COURSE_INTERVAL = 10 # 抢课间隔
...
URLS = {
    ...
    'registered_lecture_url':{
        'http': 'http://jwxk.ucas.ac.cn/subject/humanityStudent',
        'https':'https://jwxk.ucas.ac.cn/subject/humanityStudent'
    },
